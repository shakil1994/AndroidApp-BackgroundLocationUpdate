package com.example.shakil.androidbackgroundlocationupdate;
...
public class MyBackgroundService extends Service {
    ...
    private static final String EXTRA_STARTED_FROM_NOTIFICATION = "com.example.shakil.androidbackgroundlocationupdate" +
    ...
    private void getLastLocation() {
        try {
            ...
            Log.e("LOCATION", "Lost location Permission " + ex);
        }
    }
    ...
    public void requestLocationUpdates() {
        ...
        try {
            ...
            Log.e("LOCATION", "Lost location permission. Could no request it " + ex);
        }
    }
